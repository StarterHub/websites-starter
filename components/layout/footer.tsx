...
function Footer(props: LngProps) {
  ...
  return (
    <div className="w-full border-b border-gray-200 py-5 text-center dark:border-gray-700">
      ...
      {/*    href="https://github.com/StarterHub/websites-starter"*/}
      {/*    target="_blank"*/}
      ...
      <span className="mt-2 flex flex-wrap items-center justify-center text-sm text-gray-500 dark:text-gray-400 sm:text-center">
        ...
        {VERCEL_GIT_COMMIT_SHA && (
          <p className="flex items-center justify-center">
            <a
              href={`https://github.com/StarterHub/websites-starter/commit/${VERCEL_GIT_COMMIT_SHA}`}
              target="_blank"
        ...
        &nbsp;
        <Image
          src="https://visitor-badge.laobi.icu/badge?page_id=websites-starter.kjxbyz.com"
          width={60}
          height={20}
          alt="visitor badge"
        />
