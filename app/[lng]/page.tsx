...
export default function Home({
  ...
  const SectionGroup = useCallback(
    ({
      title,
      links,
      className,
  ...
  return (
    <>
      ...
      <Section className="mt-32" title={t("store")}>
        <StoreLinks lng={params.lng} />
      </Section>
      <SectionGroup className="mb-20 mt-32" title={t("app")} links={apps} />
    </>
  );
}
...
const apps = [
  {
    ...
    url: "https://kjxbyz.com/starter/websites",
    large: false,
  },
];
